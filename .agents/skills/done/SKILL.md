...
选 1 → Codex 按 Testing Trophy（文档 04 Section 1）补测试，完成后另起 commit。
选 2/3 → 记录跳过原因，继续下一步。
...
选 1 → Codex 继续执行 `/docs architecture` 流程；选 2/3 → 记录，继续。
...
选 1 → Codex 调用 /release；选 2/3 → 记录建议，继续。

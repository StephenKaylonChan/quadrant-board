...
- [ ] AGENTS.md 是否 < 200 行？（`wc -l AGENTS.md`）
- [ ] 技术栈版本与 package.json 一致？
- [ ] `.Codex/rules/` 的 paths glob 是否仍然匹配实际文件？
- [ ] `docs/roadmap/` 与 AGENTS.md 中 `@` 引用一致？
...
有则读取关键数值（AGENTS.md 行数、过时依赖数、未提交文件数等）用于趋势对比。

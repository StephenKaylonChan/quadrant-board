...
遵循项目 AGENTS.md 的完成标准和 `.Codex/rules/` 的编码红线。
...
1. (Recommended) 生成 ADR 草稿
   description: Codex 生成含 Context/Decision/Alternatives/Consequences 的草稿到 docs/architecture/adr/
2. 跳过
   description: 本次不记录
```

...
description: |
  ...
  覆盖 AGENTS.md、架构文档、开发文档、spec、ADR 等所有文档。
...
<task>
对项目所有文档执行"文档生态守护"：
1. 扫描代码实际状态 + 对比所有文档（architecture / development / specs / ADR / AGENTS.md）
...
| 参数 | 执行范围 |
|------|---------|
| 无参数 | **全量守护**：所有四种操作 × 所有文档（architecture + development + specs + ADR + AGENTS.md） |
...
```bash
git add docs/architecture/ docs/development/ docs/specs/ docs/architecture/adr/ AGENTS.md
